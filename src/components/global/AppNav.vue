<template>
  <div class="nav-bar">
    <v-app-bar color="#060665" class="pt-3" height="fit-content" absolute>
      ...
      <v-container fluid>
        <v-row>
          ...
          <v-col cols="4" class="ps-8">
            <div class="parent d-flex justify-space-between align-center">
              ...
              <div
                class="wishLists d-flex flex-column align-center text-#cd8419"
              >
                <svg
                  viewBox="0 0 512 512"
                  class="icon icon-wishlist"
                  style="width: 28px; fill: #cd8419"
                >
                  <g>
                    <g>
                      <path
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <span style="color: #cd8419" class="mt-1">Wish Lists</span>
              </div>
              <div class="wishLists d-flex flex-column align-center">
                ...
                <span style="color: #cd8419" class="mt-1">Sign In</span>
              </div>
              <div
              ...
              >
                ...
                <span style="color: #cd8419" class="mt-1">Cart</span>
              </div>
            </div>
          </v-col>
        </v-row>
