      ...
      <v-row>
        <v-col cols="12" md="6" lg="7" class="order-1 order-md-0">
          ...
          >
            ...
            />
            <div
              class="cityParent d-flex align-center justify-center"
              style="gap: 15px"
            >
              <input
                type="text"
            ...
            <v-divider length="100%" color="black"></v-divider>
            <v-card-text class="color: #777777" style="font-size: 10px"
        ...
        <v-col cols="12" md="6" lg="5">
          ...
          >
            <v-card
              ...
              color="transparent"
            >
              <v-badge :content="item.quantity" color="grey-darken-0">
                <img
                  :src="item.thumbnail"
                  alt=""
                  width="50"
...
export default {
  ...
  data() {
    return {
      countries: ["Egypt", "Lebanon", "Syria", "Albania", "Jordan"],
      dialog: false,
    };
  },
  computed: {
